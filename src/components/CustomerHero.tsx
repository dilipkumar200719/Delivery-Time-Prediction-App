...
export const CustomerHero: React.FC = () => {
  ...
  const currentEta = tracking?.etaMinutes ?? prediction?.predictedEtaMinutes ?? 24;
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-amber-100/80 bg-gradient-to-b from-amber-50/40 via-orange-50/20 to-white p-5 sm:p-8 shadow-xs">
      
      {/* Background Decorative Gradient Blobs */}
      <div className="absolute top-0 right-0 -z-10 h-72 w-72 rounded-full bg-orange-100/60 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 -z-10 h-64 w-64 rounded-full bg-cyan-50/60 blur-3xl pointer-events-none" />
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="inline-flex items-center gap-2 rounded-full bg-orange-100/80 border border-orange-200 px-3.5 py-1 text-xs font-bold text-orange-950">
              <span className="flex h-2 w-2 rounded-full bg-emerald-500 animate-ping" />
              <span>PredictEats AI • Real-Time Delivery Intelligence</span>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm sm:text-base text-slate-600 max-w-xl leading-relaxed">
                Discover top-rated restaurants across <span className="font-bold text-slate-900">{cityInfo.name}</span> with multi-modal AI predicting live kitchen prep, road bottlenecks, and courier telemetry.
              </p>
            </div>
            ...
            <form onSubmit={handleSearchSubmit} className="relative max-w-xl">
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-200 bg-white py-3.5 pl-12 pr-28 text-sm font-medium text-slate-900 placeholder:text-slate-400 shadow-sm focus:border-orange-500 focus:outline-hidden focus:ring-3 focus:ring-orange-500/10 transition-all"
                />
                <button
                  type="submit"
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              ...
              {popularSearches.map(item => (
                <button
                  ...
                  className="rounded-xl border border-slate-200 bg-white/90 hover:bg-orange-50 hover:border-orange-200 px-2.5 py-1 text-xs font-medium text-slate-700 hover:text-orange-950 shadow-2xs transition-colors"
                >
                  {item.label}
                </button>
              ))}
          ...
          <div className="lg:col-span-4">
            <div className="rounded-3xl border border-slate-200/90 bg-white p-5 sm:p-6 shadow-md space-y-4">
              ...
              <div className="rounded-2xl bg-slate-50 border border-slate-200 p-3 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-cyan-600 text-white font-bold text-xs shadow-xs">
                    RK
                  </div>
                  <div>
                    <h4 className="text-xs font-black text-slate-900">Rahul Kumar</h4>
                    <span className="text-[10px] text-slate-500 block">Ather EV • On the way</span>
                  </div>
                </div>
                <button
              ...
              <div className="pt-2 border-t border-slate-100 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="p-1.5 rounded-lg border border-slate-200 bg-white hover:bg-blue-50 text-slate-600 hover:text-blue-700 transition-colors"
                    title="Simulate Monsoon Storm (+8m)"
                  >
                  ...
                  <button
                    ...
                    title="Simulate Kitchen Surge (+6m)"
                  >
                    <Flame className="h-3.5 w-3.5 text-amber-500" />
                  </button>
                  <button
                    onClick={() => applyPreset('sunny_sprint')}
                    className="p-1.5 rounded-lg border border-slate-200 bg-white hover:bg-emerald-50 text-slate-600 hover:text-emerald-700 transition-colors"
                    title="Simulate Clear Roads (-4m)"
                  >
        ...
        <div className="rounded-2xl border border-orange-200 bg-gradient-to-r from-orange-50 via-amber-50 to-white p-4 shadow-xs flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 mt-0.5">
                Expected delivery in <span className="font-bold text-orange-950">{currentEta} mins</span> (12:38 – 12:45 PM window) • Rahul Kumar is 2.4 km away
              </p>
            </div>
          </div>
